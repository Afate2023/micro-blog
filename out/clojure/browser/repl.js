...
var seq__24405_24409 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__24406_24410 = null;
var count__24407_24411 = (0);
var i__24408_24412 = (0);
while(true){
if((i__24408_24412 < count__24407_24411)){
var str_24413 = cljs.core._nth.call(null,chunk__24406_24410,i__24408_24412);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_24413})));


var G__24414 = seq__24405_24409;
var G__24415 = chunk__24406_24410;
var G__24416 = count__24407_24411;
var G__24417 = (i__24408_24412 + (1));
seq__24405_24409 = G__24414;
chunk__24406_24410 = G__24415;
count__24407_24411 = G__24416;
i__24408_24412 = G__24417;
continue;
} else {
var temp__5735__auto___24418 = cljs.core.seq.call(null,seq__24405_24409);
if(temp__5735__auto___24418){
var seq__24405_24419__$1 = temp__5735__auto___24418;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__24405_24419__$1)){
var c__4550__auto___24420 = cljs.core.chunk_first.call(null,seq__24405_24419__$1);
var G__24421 = cljs.core.chunk_rest.call(null,seq__24405_24419__$1);
var G__24422 = c__4550__auto___24420;
var G__24423 = cljs.core.count.call(null,c__4550__auto___24420);
var G__24424 = (0);
seq__24405_24409 = G__24421;
chunk__24406_24410 = G__24422;
count__24407_24411 = G__24423;
i__24408_24412 = G__24424;
continue;
} else {
var str_24425 = cljs.core.first.call(null,seq__24405_24419__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_24425})));


var G__24426 = cljs.core.next.call(null,seq__24405_24419__$1);
var G__24427 = null;
var G__24428 = (0);
var G__24429 = (0);
seq__24405_24409 = G__24426;
chunk__24406_24410 = G__24427;
count__24407_24411 = G__24428;
i__24408_24412 = G__24429;
continue;
}
} else {
}
...
var temp__5733__auto__ = clojure.browser.net.xpc_connection.call(null);
if(cljs.core.truth_(temp__5733__auto__)){
var repl_connection = temp__5733__auto__;
var connection = clojure.browser.net.xhr_connection.call(null);
var repl_connected_QMARK_ = cljs.core.atom.call(null,false);
var try_handshake = ((function (connection,repl_connected_QMARK_,repl_connection,temp__5733__auto__){
...
});})(connection,repl_connected_QMARK_,repl_connection,temp__5733__auto__))
;
clojure.browser.net.connect.call(null,repl_connection,try_handshake);

clojure.browser.net.register_service.call(null,repl_connection,new cljs.core.Keyword(null,"ack-handshake","ack-handshake",1651340387),((function (connection,repl_connected_QMARK_,try_handshake,repl_connection,temp__5733__auto__){
return (function (_){
if(cljs.core.truth_(cljs.core.deref.call(null,repl_connected_QMARK_))){
return null;
} else {
...
});})(connection,repl_connected_QMARK_,try_handshake,repl_connection,temp__5733__auto__))
);

clojure.browser.event.listen.call(null,connection,new cljs.core.Keyword(null,"success","success",1890645906),((function (connection,repl_connected_QMARK_,try_handshake,repl_connection,temp__5733__auto__){
return (function (e){
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"evaluate-javascript","evaluate-javascript",-315749780),e.currentTarget.getResponseText(cljs.core.List.EMPTY));
});})(connection,repl_connected_QMARK_,try_handshake,repl_connection,temp__5733__auto__))
);

clojure.browser.net.register_service.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),((function (connection,repl_connected_QMARK_,try_handshake,repl_connection,temp__5733__auto__){
...
return clojure.browser.net.register_service.call(null,repl_connection,new cljs.core.Keyword(null,"print","print",1299562414),((function (connection,repl_connected_QMARK_,try_handshake,repl_connection,temp__5733__auto__){
return (function (json){
var obj = goog.json.parse(json);
var repl = goog.object.get(obj,"repl");
...
var script__$1 = (function (){var G__24434 = script;
goog.object.set(G__24434,"type","text/javascript");

goog.object.set(G__24434,"onload",onload);

goog.object.set(G__24434,"onreadystatechange",onload);

return G__24434;
})();
if((opt_sourceText == null)){
var G__24435 = script__$1;
goog.object.set(G__24435,"src",src);

return G__24435;
} else {
var G__24436 = script__$1;
goog.dom.setTextContext(G__24436,opt_sourceText);
...
var path_24437 = goog.debugLoader_.getPathFromDeps_(cljs.core.name);
goog.object.remove(goog.debugLoader_.written_,path_24437);

goog.object.remove(goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_24437)].join(''));
} else {
var path_24438 = goog.object.get(goog.dependencies_.nameToPath,src);
goog.object.remove(goog.dependencies_.visited,path_24438);

goog.object.remove(goog.dependencies_.written,path_24438);

goog.object.remove(goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_24438)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__24439 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__24440 = repl;
clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__24440;

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__24439;
}})()})));
});})(connected_QMARK_,repl_connection))
);
